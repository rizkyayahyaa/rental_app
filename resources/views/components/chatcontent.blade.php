    ...
    <div class="card mb-0">
        ...
        <div class="card-header msg_head">
            <div class="d-flex bd-highlight">
                ...
                <div class="img_cont">
                    <img class="rounded-circle user_img" src="{{ URL::asset('/assets/img/profiles/avatar-02.jpg')}}" alt="">
                </div>
                <div class="user_info">
            ...
            <div class="chat-options">
                <ul>
                    ...
                    <li><a href="javascript:;" class="with-bg"><i class="feather-more-horizontal"></i></a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="card-body msg_card_body chat-scroll pt-0">
            <ul class="list-unstyled">
                                    ...
                                    <li>
                                        ...
                                        <div class="drop-item">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="javascript:;"><i class="feather-trash-2"></i> Delete</a>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                ...
                <li class="media sent d-flex">
                    <div class="avatar flex-shrink-0">
                        <img src="{{ URL::asset('/assets/img/provider/provider-01.jpg')}}" alt="User Image" class="avatar-img rounded-circle">
                    </div>
                    <div class="media-body flex-grow-1">
                        <div class="msg-box">
                            <div>
