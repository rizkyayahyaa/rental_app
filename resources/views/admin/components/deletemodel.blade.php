...
<div class="modal fade" id="delete-item" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered ">
        <div class="modal-content">
            ...
            @if (
                !Route::is([
                    'sub-categories','services','pending-services', 'deleted-services','inactive-services',
                    'review-type','sales-transactions', 'tax-rates', 'pages-list', 'page-list','blogs-categories',
                    'blogs-comments','countries', 'states','cities', 'testimonials', 'faq', 'admin-earnings','provider-earnings',
                    'user-list','user-customers','user-providers', 'delete-account-requests','marketing-coupons','marketing-service',
                    'marketing-featured','marketing-newsletter','email-templates', 'sms-templates','menu-management','plugins-manager',
                    'contact-messages','abuse-reports', 'announcements', 'language', 'currencies', 'ban-ip-address', 'system-backup',
                    'database-backup', 'all-blog', 'pending-blog', 'inactive-blog', 'payment-settings'
                ]))
