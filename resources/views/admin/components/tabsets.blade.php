    ...
    <div class="col-12">
        <div class="tab-sets">
            <div class="tab-contents-sets">
                @if (Route::is(['services', 'pending-services', 'deleted-services', 'inactive-services']))
                    <ul>
                        <li>
                        ...
                        <li>
                            <a class="{{ Request::is('admin/pending-services') ? 'active' : '' }}"
                                href="{{ url('admin/pending-services') }}">Pending Services</a>
                        </li>
                        <li>
                            <a class="{{ Request::is('admin/deleted-services') ? 'active' : '' }}"
                                href="{{ url('admin/deleted-services') }}">Deleted Services</a>
                        </li>
                        <li>
                            <a class="{{ Request::is('admin/inactive-services') ? 'active' : '' }}"
                                href="{{ url('admin/inactive-services') }}">Inactive Services</a>
                        </li>
                    </ul>
                @endif
